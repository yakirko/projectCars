    ...
    <div class="row">
      ...
      <form action="{{ url('cms/products/'.$products['id']) }}" method="POST" novalidate="novalidate" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <select name="categorie_id" class="form-control" id="categorie_id">
               ...
               @foreach ($categories as $cat)
                  <option value="{{$cat['id']}}" 
                  @if ($cat['id'] == $products['categorie_id']) selected  @endif>{{$cat['title']}}</option>
               @endforeach
            </select>
          </div>  
        ...
        <div class="form-group">
          ...
          <input value="{{ $products['ptitle'] }}" type="text" name="ptitle" id="ptitle" class="form-control field-input-cms original-text">
        ...
        <div class="form-group">
          <label for="purl"><span class="text-danger">*</span> Url</label>
          <input value="{{ $products['purl'] }}" type="text" name="purl" id="purl" class="form-control field-input-cms original-text">
        ...
        <div class="form-group">
          ...
          <input value="{{ $products['price'] }}" type="text" name="price" id="price" class="form-control field-input-cms original-text">
          <small class="text-muted">must be bigger then 1</small><br>
        ...
        <div class="form-group">
          ...
          <textarea name="article" id="article" class="form-control">{{ $products['article'] }}</textarea>
